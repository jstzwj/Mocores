...
namespace mocores
{
    ...
    public:
        ...
        {
            if(detail::HasType<U,T,Targs...>::value==true)
            {
                data=new U(value);
                curindex=detail::GetIndex<U,T,Targs...>::index;
            }
            else
            {
                throw "Unknown type.";
        ...
        {
            detail::Copy<U,args...>::copy(other.curindex,other.data,this->data);
        ...
        MVariant& operator =(MVariant<U,args...>& other)
        {
            if(data!=nullptr)
            {
                detail::Destruct<T,Targs...>::destruct(curindex,data);
            }
            detail::Copy<U,args...>::copy(other.curindex,other.data,this->data);
            this->curindex=other.curindex;
        }
    ...
    {
        if(detail::GetIndex<T,U,Types...>::index==v.curindex)
        {
